...
const kanjiData = [
    ...
    { id: "yama", kanji: "山", onyomi: "サン", kunyomi: "やま", meaning: "mountain", examples: [{ sentence: "富士山（ふじさん）に登（のぼ）りました", reading: "ふじさんにのぼりました", english: "I climbed Mount Fuji" }, { sentence: "山（やま）が高（たか）いです", reading: "やまがたかいです", english: "The mountain is high" }] },
