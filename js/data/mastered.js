...
// ============================================================
// IMPORTANT: Mark this data file as loaded for the data loader
// ============================================================
if (typeof markDataLoaded === 'function') {
    markDataLoaded('mastered');
    console.log('✅ mastered.js loaded and marked');
} else {
    // Fallback: mark it manually if markDataLoaded isn't available yet
    if (window.dataLoading) {
        window.dataLoading.loaded.mastered = true;
        console.log('✅ mastered.js loaded (manual fallback)');
    }
}